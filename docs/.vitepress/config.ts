    ...
    sidebar: {
      '/quant-finance/': [
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/quant-finance/01.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/quant-finance/02.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/quant-finance/03.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/quant-finance/04.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/quant-finance/05.0-overview' },
      ...
      '/prerequisite-math/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/prerequisite-math/01-calculus/01.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/prerequisite-math/02-linear-algebra/02.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/prerequisite-math/03-probability/03.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/prerequisite-math/04-statistics/04.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/prerequisite-math/05-optimization/05.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/prerequisite-math/06-stochastic-processes/06.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/prerequisite-math/07-information-theory/07.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/prerequisite-math/08-fourier-analysis/08.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/prerequisite-math/09-numerical-computing/09.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '概述', link: '/prerequisite-math/10-graph-theory/10.0-overview' },
