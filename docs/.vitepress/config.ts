    ...
    sidebar: {
      '/quant-finance/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '2.0 章节概览', link: '/quant-finance/02.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '3.0 章节概览', link: '/quant-finance/03.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '4.0 章节概览', link: '/quant-finance/04.0-overview' },
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '5.0 章节概览', link: '/quant-finance/05.0-overview' },
      ...
      '/learn/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '3.1 线性代数 (L1+L2)', link: '/learn/03-math-toolbox/01-linear-algebra' },
            { text: '3.2 概率与蒙特卡洛 (L3)', link: '/learn/03-math-toolbox/02-probability' },
            { text: '3.3 矩阵分解 (L4)', link: '/learn/03-math-toolbox/03-matrix-decomposition' },
            { text: '3.4 随机过程 (L5)', link: '/learn/03-math-toolbox/04-stochastic-processes' },
            { text: '3.5 回归分析 (L6)', link: '/learn/03-math-toolbox/05-regression' },
            { text: '3.6 VaR与商品 (L7+L13)', link: '/learn/03-math-toolbox/06-var-commodity' },
            { text: '3.7 时间序列 (L8+L11+L12)', link: '/learn/03-math-toolbox/07-time-series' },
            { text: '3.8 波动率建模 (L9)', link: '/learn/03-math-toolbox/08-volatility' },
            { text: '3.9 正则化模型 (L10)', link: '/learn/03-math-toolbox/09-regularization' },
            { text: '3.10 组合理论 (L14-16)', link: '/learn/03-math-toolbox/10-portfolio-theory' },
          ],
        },
        {
          text: '第四章：量化编程速成',
          collapsed: true,
          items: [
            { text: '4.1 NumPy基础', link: '/learn/04-python-quant/01-numpy-pandas' },
